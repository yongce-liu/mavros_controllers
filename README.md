...
- [Install Mavros](https://docs.px4.io/main/en/ros/mavros_installation)
  - Note that please run
  - `bash ./PX4-Autopilot/Tools/setup/ubuntu.sh`
- [ROS with Gazebo Classic Simulation](https://docs.px4.io/main/en/simulation/ros_interface)
...
cd ~/catkin_ws/src
git clone https://github.com/yongce-liu/mavros_controllers
